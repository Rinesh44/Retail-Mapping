...
public class MaterialRequest extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Window window = MaterialRequest.this.getWindow();
...
// finally change the color
        if(Build.VERSION.SDK_INT >= 21)
            window.setStatusBarColor(MaterialRequest.this.getResources().getColor(R.color.colorPrimaryDark));
        ...
        adapter = new SimpleAdapter(MaterialRequest.this, shopList,
        ...
        if (InternetConnection.checkConnection(MaterialRequest.this)) {
            try {
                run();
            } catch (IOException e) {
                e.printStackTrace();
            ...
            Toast.makeText(MaterialRequest.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
    ...
    void run() throws IOException{
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try{
                    ...
                    if(myResponse != null) {
                        ...
                        Toast.makeText(MaterialRequest.this, "No Data found", Toast.LENGTH_SHORT).show();
                ...
                MaterialRequest.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent in = new Intent(MaterialRequest.this, MaterialRequestForm.class);
                        ...
                        search.addTextChangedListener(new TextWatcher() {
                            ...
                            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                                ...
                                MaterialRequest.this.adapter.getFilter().filter(cs);
                            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Toast.makeText(MaterialRequest.this, R.string.error, Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
