...
//        actionBar.hide();
        ...
        ActivityCompat.requestPermissions(ClientActivity.this, PERMISSIONS_STORAGE, REQUEST_PERMISSIONS);
        ...
        ClientFragmentPagerAdapter adapter = new ClientFragmentPagerAdapter(getSupportFragmentManager());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.client_overflow, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.furniture_request: {
                Intent enter_funiture_request = new Intent(ClientActivity.this, FurnitureRequest.class);
                startActivity(enter_funiture_request);
                break;
            }

            case R.id.board_request: {
                Intent enter_material_request = new Intent(ClientActivity.this, MaterialRequest.class);
