...
public class FieldTeamDetails extends AppCompatActivity {
    TextView particulars, brand, height, width, qty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_field_team_details);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.add_after_image: {
                Intent enter_add_after_image = new Intent(FieldTeamDetails.this, AfterImage.class);
                enter_add_after_image.putExtra("fieldenquiry_id", valueFieldId);
                startActivity(enter_add_after_image);
            }
        }
        return false;
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.field_team_details_overflow, menu);
        return true;
    }
}
